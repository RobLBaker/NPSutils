...
> project - Refer this project in your project’s readme - Mention the
> project at local meetups and tell your friends/colleagues - Cite these
> packages in your published works
...
> available
> [Documentation](https://nationalparkservice.github.io/NPSutils/).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/nationalparkservice/NPSutils/issues) that
...
- Open an
  [Issue](https://github.com/nationalparkservice/NPSutils/issues/new/choose).
...
- Determine if your bug is really a bug and not an error on your side
  ...
  [documentation](https://nationalparkservice.github.io/NPSutils/). If
  you are looking for support, you might want to check [this
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/nationalparkservice/NPSutils/issues/new/choose).
...
- Please provide as much context as possible and describe the
  *reproduction steps* that someone else can follow to recreate the
  ...
  See <https://gist.github.com/hadley/270442> for a great run down on
...
- If the team is able to reproduce the issue, it will be marked
  `needs-fix`, as well as possibly other tags, and the issue will be
  left to be implemented by someone on the development team. You may
  also address the issue yourself and issue a pull request, which will
  be reviewed by the development team.

### Suggesting Enhancements

This section guides you through submitting an enhancement **including
completely new features and minor improvements to existing
...
- Perform a
  [search](https://github.com/nationalparkservice/NPSutils/issues) to
...
- Find out whether your idea fits with the scope and aims of the
  ...
  consider writing an add-on/plugin library or package.
- Please consult with the developers if you would like to create an
  add-on package. Maybe we can help!
...
- You may want to **include screenshots and animated GIFs** which help
  ...
  is related to. There is good free software for generating these GIFs
...
If you would like to contribute code please make the adjustments and
issue a pull request. The development team will review your code prior
to merging and pull request. Before issuing a pull request make sure: 1)
You have added a description of any changes made to the changelog in
...
We encourage the use of the [tidyverse style
